...
class Grader(object):
    ...
    def submit_vlb(self, sess, vlb_binomial):
        ...
        loss,loss1,loss2 = vlb_binomial(my_x, my_x_decoded, my_t_mean, my_t_log_var)
        try:
            output, out1, out2 = sess.run([loss,loss1,loss2], feed_dict={my_x: test_data['x'], my_x_decoded: test_data['x_decoded_mean'],
        ...
        # print(test_data['x'][7,:].reshape((28,28)))
        # img = test_data['x_decoded_mean'][7,:].reshape((28,28))
        #print(img)
        # print(np.sum(llll))
        '''
        sss = ""
        ...
        print(sss)
        '''
        # print(np.where(test_data['x'][7:]!=0))
